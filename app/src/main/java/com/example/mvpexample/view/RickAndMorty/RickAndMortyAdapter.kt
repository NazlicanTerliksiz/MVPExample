...
class RickAndMortyAdapter(): RecyclerView.Adapter<RickAndMortyAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(val binding: ItemViewCharacterBinding ): RecyclerView.ViewHolder(binding.root)
    ...
    fun updateList(rickAndMortyList: MutableList<Result>){
        rickAndMortyList.clear()
        rickAndMortyList.addAll(rickAndMortyList)
